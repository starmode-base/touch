...
CREATE TABLE "contact_role_assignments" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "contact_role_assignments_workspace_id_contact_id_contact_role_id_pk" PRIMARY KEY("workspace_id","contact_id","contact_role_id")
);
--> statement-breakpoint
CREATE TABLE "contact_roles" (
	...
	"key" text NOT NULL,
	"name" text NOT NULL,
	CONSTRAINT "contact_roles_workspaceId_key_unique" UNIQUE("workspace_id","key"),
	CONSTRAINT "contact_roles_workspaceId_id_unique" UNIQUE("workspace_id","id")
);
--> statement-breakpoint
CREATE TABLE "contacts" (
	...
	CONSTRAINT "contacts_workspaceId_id_unique" UNIQUE("workspace_id","id")
);
--> statement-breakpoint
CREATE TABLE "opportunities" (
	...
	CONSTRAINT "opportunities_workspaceId_id_unique" UNIQUE("workspace_id","id")
);
--> statement-breakpoint
...
CREATE TABLE "opportunity_contact_links" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "opportunity_contact_links_workspace_id_opportunity_id_contact_id_pk" PRIMARY KEY("workspace_id","opportunity_id","contact_id")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" text PRIMARY KEY DEFAULT gen_secure_token() NOT NULL,
...
ALTER TABLE "contact_role_assignments" ADD CONSTRAINT "contact_role_assignments_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contact_role_assignments" ADD CONSTRAINT "contact_role_assignments_workspace_id_contact_id_contacts_workspace_id_id_fk" FOREIGN KEY ("workspace_id","contact_id") REFERENCES "public"."contacts"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contact_role_assignments" ADD CONSTRAINT "contact_role_assignments_workspace_id_contact_role_id_contact_roles_workspace_id_id_fk" FOREIGN KEY ("workspace_id","contact_role_id") REFERENCES "public"."contact_roles"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contact_roles" ADD CONSTRAINT "contact_roles_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "opportunity_contact_links" ADD CONSTRAINT "opportunity_contact_links_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "opportunity_contact_links" ADD CONSTRAINT "opportunity_contact_links_workspace_id_contact_id_contacts_workspace_id_id_fk" FOREIGN KEY ("workspace_id","contact_id") REFERENCES "public"."contacts"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "opportunity_contact_links" ADD CONSTRAINT "opportunity_contact_links_workspace_id_opportunity_id_opportunities_workspace_id_id_fk" FOREIGN KEY ("workspace_id","opportunity_id") REFERENCES "public"."opportunities"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
